...
This section is mostly for anyone who might have found this who doesn't already know me. I'm an artist, but also a web developer, and in the last year and change I started working *a lot* on a thing called [Octothorpes](https://docs.octothorp.es/pitch/). Octothorpe is another word for hashtag, and octothorpes are hashtags you can use on regular websites, without a platform. There are some on this page. The whole system is called [OP](https://docs.octothorp.es/about) and it's an attempt to give you a lot of the stuff that social media does, but on your own page, under your own control.

I'm not an open-source purist, but I guess I'm  pretty high on the nerd scale compared to average. (Maybe half of this site is written in markdown on a 12-year-old Thinkpad running Peppermint Linux, and the rest is on my M1 Macbook.) I build a lot of small sites, and have run a few small social networks for friends, including a self-hosted forum and a Discord, and have run or participated in small-to-medium sized research, critique, and art groups IRL. I've also been doing a lot of work in the small / open web space this year because of [Octothorpes](https://octothorp.es). Oct and I got very, very lucky [to go to the last XOXO festival](https://www.mmmx.cloud/after-xoxo) where "how can we fix the fucking networks" was the hot topic. I highly, *highly* recommend [reading / watching Erin Kissane's](https://erinkissane.com/xoxo) talk she gave at XOXO. 
